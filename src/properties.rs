    ...
    pub fn new(elementtype: ElementType) -> Self {
        ...
        match elementtype {
            ElementType::ActorFeature => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Description)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![];
            ...
            ElementType::AlternativeLayers => {
                ...
                properties.annotationtype = Some(AnnotationType::ALTERNATIVE);
                properties.accepted_data = vec![AcceptedData::AcceptElementGroup(ElementGroup::Layer), AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPEAKER,AttribType::SRC ];
                properties.occurrences = 0;
            ...
            ElementType::Caption => {
                ...
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPACE,AttribType::SPEAKER,AttribType::SRC ];
            ...
            ElementType::Chunk => {
                ...
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPEAKER,AttribType::SRC,AttribType::TEXTCLASS ];
                properties.occurrences = 0;
                properties.occurrences_per_set = 0;
                properties.textdelimiter = None;
                properties.printable = true;
            ...
            ElementType::ChunkingLayer => {
                ...
                properties.annotationtype = Some(AnnotationType::CHUNKING);
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Chunk), AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
                properties.occurrences_per_set = 0;
                properties.textdelimiter = None;
                properties.printable = false;
            ...
            ElementType::Comment => {
                ...
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ID,AttribType::METADATA,AttribType::N ];
                properties.occurrences = 0;
                properties.occurrences_per_set = 0;
                properties.textdelimiter = None;
                properties.printable = false;
            ...
            ElementType::Content => {
                ...
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::METADATA ];
                properties.occurrences = 0;
                properties.occurrences_per_set = 0;
                properties.textdelimiter = None;
                properties.printable = true;
            ...
            ElementType::CoreferenceChain => {
                ...
                properties.required_data = vec![AcceptedData::AcceptElementType(ElementType::CoreferenceLink)];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPEAKER,AttribType::SRC,AttribType::TEXTCLASS ];
                properties.occurrences = 0;
                properties.occurrences_per_set = 0;
            ...
            ElementType::CoreferenceLayer => {
                ...
                properties.annotationtype = Some(AnnotationType::COREFERENCE);
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::CoreferenceChain), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
            ...
            ElementType::Correction => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Current), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ErrorDetection), AcceptedData::AcceptElementType(ElementType::Feature), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::Metric), AcceptedData::AcceptElementType(ElementType::New), AcceptedData::AcceptElementType(ElementType::Original), AcceptedData::AcceptElementType(ElementType::Suggestion)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPEAKER,AttribType::SRC ];
                properties.occurrences = 0;
                properties.occurrences_per_set = 0;
                properties.textdelimiter = None;
                properties.printable = true;
            ...
            ElementType::Current => {
                ...
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ID,AttribType::N ];
                properties.occurrences = 1;
                properties.occurrences_per_set = 0;
                properties.textdelimiter = None;
                properties.printable = true;
            ...
            ElementType::DependenciesLayer => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Dependency), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
            ...
            ElementType::Dependency => {
                ...
                properties.required_data = vec![AcceptedData::AcceptElementType(ElementType::DependencyDependent), AcceptedData::AcceptElementType(ElementType::Headspan)];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPEAKER,AttribType::SRC,AttribType::TEXTCLASS ];
                properties.occurrences = 0;
                properties.occurrences_per_set = 0;
            ...
            ElementType::DomainAnnotation => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::Feature), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::Metric)];
                properties.required_data = vec![];
                properties.required_attribs = vec![ AttribType::CLASS ];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPEAKER,AttribType::SRC,AttribType::TEXTCLASS ];
                properties.occurrences = 0;
            ...
            ElementType::EntitiesLayer => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::Entity), AcceptedData::AcceptElementType(ElementType::ForeignData)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
            ...
            ElementType::External => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Description)];
                properties.required_data = vec![];
                properties.required_attribs = vec![ AttribType::SRC ];
                properties.optional_attribs = vec![];
                properties.occurrences = 0;
                properties.occurrences_per_set = 0;
                properties.textdelimiter = None;
            ...
            ElementType::Gap => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Content), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::Feature), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::Metric), AcceptedData::AcceptElementType(ElementType::Part)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SRC ];
                properties.occurrences = 0;
                properties.occurrences_per_set = 0;
                properties.textdelimiter = None;
                properties.printable = false;
            ...
            ElementType::Hiddenword => {
                ...
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPACE,AttribType::SPEAKER,AttribType::SRC,AttribType::TEXTCLASS ];
                properties.occurrences = 0;
                properties.occurrences_per_set = 0;
                properties.textdelimiter = Some("\n\n");
                properties.printable = true;
            ...
            ElementType::Hyphbreak => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementGroup(ElementGroup::TextMarkup), AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::Linebreak)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPEAKER,AttribType::SRC ];
                properties.occurrences = 0;
            ...
            ElementType::LinkReference => {
                ...
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::IDREF ];
                properties.occurrences = 0;
                properties.occurrences_per_set = 0;
                properties.textdelimiter = None;
                properties.printable = false;
            ...
            ElementType::Metric => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::Feature), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::ValueFeature)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPEAKER,AttribType::SRC ];
                properties.occurrences = 0;
            ...
            ElementType::MorphologyLayer => {
                ...
                properties.annotationtype = Some(AnnotationType::MORPHOLOGICAL);
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::Morpheme)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
            ...
            ElementType::ObservationLayer => {
                ...
                properties.annotationtype = Some(AnnotationType::OBSERVATION);
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::Observation)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
            ...
            ElementType::PhonologyLayer => {
                ...
                properties.annotationtype = Some(AnnotationType::PHONOLOGICAL);
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::Phoneme)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
            ...
            ElementType::PosAnnotation => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::Feature), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::HeadFeature), AcceptedData::AcceptElementType(ElementType::Metric)];
                properties.required_data = vec![];
                properties.required_attribs = vec![ AttribType::CLASS ];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPEAKER,AttribType::SRC,AttribType::TEXTCLASS ];
                properties.occurrences = 0;
            ...
            ElementType::Relation => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::Feature), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::LinkReference), AcceptedData::AcceptElementType(ElementType::Metric)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPEAKER,AttribType::SRC ];
                properties.occurrences = 0;
            ...
            ElementType::SemanticRolesLayer => {
                ...
                properties.annotationtype = Some(AnnotationType::SEMROLE);
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::Predicate), AcceptedData::AcceptElementType(ElementType::SemanticRole)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
            ...
            ElementType::SenseAnnotation => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::Feature), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::Metric), AcceptedData::AcceptElementType(ElementType::SynsetFeature)];
                properties.required_data = vec![];
                properties.required_attribs = vec![ AttribType::CLASS ];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPEAKER,AttribType::SRC,AttribType::TEXTCLASS ];
                properties.occurrences = 0;
            ...
            ElementType::SentimentLayer => {
                ...
                properties.annotationtype = Some(AnnotationType::SENTIMENT);
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::Sentiment)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
            ...
            ElementType::SpanRelation => {
                ...
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::Feature), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::Metric), AcceptedData::AcceptElementType(ElementType::Relation)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SPEAKER,AttribType::SRC ];
                properties.occurrences = 0;
            ...
            ElementType::SpanRelationLayer => {
                ...
                properties.annotationtype = Some(AnnotationType::SPANRELATION);
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::SpanRelation)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
            ...
            ElementType::StatementLayer => {
                ...
                properties.annotationtype = Some(AnnotationType::STATEMENT);
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::Statement)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
            ...
            ElementType::String => {
                ...
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ANNOTATOR,AttribType::BEGINTIME,AttribType::CLASS,AttribType::CONFIDENCE,AttribType::DATETIME,AttribType::ENDTIME,AttribType::ID,AttribType::METADATA,AttribType::N,AttribType::SRC ];
                properties.occurrences = 0;
                properties.occurrences_per_set = 0;
                properties.textdelimiter = None;
                properties.printable = true;
            ...
            ElementType::SyntaxLayer => {
                ...
                properties.annotationtype = Some(AnnotationType::SYNTAX);
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::SyntacticUnit)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
            ...
            ElementType::TimingLayer => {
                ...
                properties.annotationtype = Some(AnnotationType::TIMESEGMENT);
                properties.accepted_data = vec![AcceptedData::AcceptElementType(ElementType::Comment), AcceptedData::AcceptElementType(ElementType::Correction), AcceptedData::AcceptElementType(ElementType::Description), AcceptedData::AcceptElementType(ElementType::ForeignData), AcceptedData::AcceptElementType(ElementType::TimeSegment)];
                properties.required_data = vec![];
                properties.required_attribs = vec![];
                properties.optional_attribs = vec![ AttribType::ID ];
                properties.occurrences = 0;
